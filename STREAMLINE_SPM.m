function [Mx,My] = STREAMLINE_SPM(XP,YP,XB,YB,phi,L)
...
% Initialize arrays
Mx = zeros(cp,1);                                                       % Initialize Mx integral array
My = zeros(cp,1);                                                       % Initialize My integral array

% Compute Mx and My
for j = 1:1:cp                                                          % Loop over the j panels
